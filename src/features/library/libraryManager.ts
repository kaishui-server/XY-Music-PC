import { getLibraryAddScanOptions, resolveScanLibraryOptions } from './libraryScan';
...
interface CreateLibraryManagerDeps {
...
export const createLibraryManager = ({
  fetchFolderTree,
  scanLibrary,
  playSong,
  dedupePaths,
